...
class WPMProducts extends Widget_Base {
	...
	public function __construct( $data = array(), $args = null ) {
		...
		wp_register_style( 'wpmproducts', plugins_url( '/assets/css/wpmproducts.css', Elementor_WPM_Products ), array(), '1.0.4' );
	}
	...
	public function get_icon() {
		return 'fa-brands fa-product-hunt';	// eicon-products / fa-brands fa-product-hunt / fa-solid fa-bag-shopping
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'what_section',
			array(
				'label' => __( 'What products to show', 'elementor-wpm-products' ),
		...
		$this->start_controls_section(
			'order_section',
			array(
				'label' => __( 'In what order', 'elementor-wpm-products' ),
				'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
			)
		);
