...
namespace ElementorWPMProducts;
...
class Widgets {
	...
	private function include_widgets_files() {
		require_once 'widgets/class-wpm-products.php';
	}
	...
	public function register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Widgets\WPMProducts() );
	}
